...
describe('Pipeline Editor tests', () => {
  ...
  afterEach(() => {
    cy.execDeleteFile('helloworld.ipynb'); // delete notebook file used for testing
    cy.execDeleteFile('helloworld.py'); // delete python file used for testing
    cy.execDeleteFile('output.txt'); // delete output files generated by tests
