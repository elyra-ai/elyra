    ...
    5405: (e, t, a) => {
      ...
      class u extends o.ReactWidget {
        ...
        async initializeMetadata() {
          const e = await s.u9.getSchema(this.namespace);
          for (const t of e)
          ...
          if (
            ((this.allMetadata = await s.u9.getMetadata(this.namespace)),
            this.name)
          ) {
        ...
        saveMetadata() {
          ...
          this.hasInvalidFields()
            ...
            : this.name
            ? s.u9
                .putMetadata(this.namespace, this.name, JSON.stringify(e))
                .then(e => {
                  this.handleDirtyState(!1), this.onSave(), this.close();
                })
            : s.u9.postMetadata(this.namespace, JSON.stringify(e)).then(e => {
                this.handleDirtyState(!1), this.onSave(), this.close();
              });
        }
        ...
        handleDirtyState(e) {
          (this.dirty = e),
            ...
            this.dirty && !this.title.className.includes(p)
              ? (this.title.className += p)
              : this.dirty ||
                (this.title.className = this.title.className.replace(p, ''));
        }
        onUpdateRequest(e) {
          if (
        ...
        renderTextInput(e, t, a, s, r, o, d) {
          ...
          return (
            o &&
              (this.showSecure[a] ? (p = !0) : (this.showSecure[a] = !1),
              (m = c.createElement(
                n.u,
                { content: (p ? 'Hide' : 'Show') + ' Password' },
                c.createElement(l.Button, {
                  icon: p ? 'eye-open' : 'eye-off',
                  intent: i.S.WARNING,
                  minimal: !0,
                  onClick: () => {
      ...
      class b extends m().Component {
          ...
          super(...arguments),
            (this.deleteMetadata = e =>
              (0, o.showDialog)({
                ...
                t.button.accept &&
                  s.u9.deleteMetadata(this.props.namespace, e.name);
              })),
        ...
        renderExpandableContent(e) {
          return m().createElement(
            ...
            m().createElement(r.vK, { json: e.metadata })
          );
        }
        sortMetadata() {
      ...
      class E extends o.ReactWidget {
        ...
        async getSchema() {
          const e = await s.u9.getSchema(this.props.namespace);
          for (const t of e)
        ...
        async fetchMetadata() {
          return await s.u9.getMetadata(this.props.namespace);
        }
        updateMetadata() {
          ...
          return m().createElement(
            ...
            m().createElement(
              ...
              m().createElement(
                ...
                m().createElement(l.addIcon.react, {
                  tag: 'span',
