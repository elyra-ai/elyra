  ...
  [672],
  {
    1672: (t, e, a) => {
      ...
      a.r(e),
        a.d(e, {
          DropDown: () => S,
          ExpandableComponent: () => w,
          ExpandableErrorDialog: () => u,
          IconUtil: () => F,
          JSONComponent: () => _,
          clearPipelineIcon: () => Z,
          codeSnippetIcon: () => L,
          containerIcon: () => N,
          disableDialogButton: () => x,
          dragDropIcon: () => D,
          elyraIcon: () => k,
          enableDialogButton: () => f,
          errorIcon: () => H,
          exportPipelineIcon: () => A,
          helpIcon: () => B,
          importIcon: () => M,
          pipelineIcon: () => E,
          runtimesIcon: () => I,
          savePipelineIcon: () => V,
          showBrowseFileDialog: () => o,
          showFormDialog: () => y,
          trashIcon: () => P
        });
      var l = a(4268),
        s = a(5875),
        n = a(2916);
      const i = 'elyra-browseFileDialog-open';
      class c extends s.BreadCrumbs {
        constructor(t) {
          super(t), (this.model = t.model), (this.rootPath = t.rootPath);
        }
        onUpdateRequest(t) {
          super.onUpdateRequest(t);
          const e = this.model.manager.services.contents.localPath(
            this.model.path
          );
          e &&
            this.rootPath &&
            0 === e.indexOf(this.rootPath) &&
            document
              .querySelectorAll(
                '.elyra-browseFileDialog .jp-BreadCrumbs > span[title]'
              )
              .forEach(t => {
                0 === t.title.indexOf(this.rootPath)
                  ? (t.className = t.className
                      .replace('elyra-BreadCrumbs-disabled', '')
                      .trim())
                  : -1 === t.className.indexOf('elyra-BreadCrumbs-disabled') &&
                    (t.className += ' elyra-BreadCrumbs-disabled');
              });
        }
      }
      class r extends n.Widget {
        constructor(t) {
          super(t),
            (this.model = new s.FilterFileBrowserModel({
              manager: t.manager,
              filter: t.filter
            }));
          const e = (this.layout = new n.PanelLayout());
          (this.directoryListing = new s.DirListing({ model: this.model })),
            (this.acceptFileOnDblClick = t.acceptFileOnDblClick),
            (this.multiselect = t.multiselect),
            (this.includeDir = t.includeDir),
            (this.dirListingHandleEvent = this.directoryListing.handleEvent),
            (this.directoryListing.handleEvent = t => {
              this.handleEvent(t);
            }),
            (this.breadCrumbs = new c({
              model: this.model,
              rootPath: t.rootPath
            })),
            e.addWidget(this.breadCrumbs),
            e.addWidget(this.directoryListing);
        }
        static async init(t) {
          const e = new r(t);
          return (
            t.startPath
              ? (t.rootPath && 0 !== t.startPath.indexOf(t.rootPath)) ||
                (await e.model.cd(t.startPath))
              : t.rootPath && (await e.model.cd(t.rootPath)),
            e
          );
        }
        getValue() {
          const t = this.directoryListing.selectedItems(),
            e = [];
          let a = null;
          for (; void 0 !== (a = t.next()); )
            (this.includeDir || 'directory' !== a.type) && e.push(a);
          return e;
        }
        handleEvent(t) {
          let e = !1;
          switch (
            ((t instanceof MouseEvent || t instanceof KeyboardEvent) &&
              (e = t.shiftKey || t.metaKey),
            t.type)
          ) {
            case 'keydown':
            case 'keyup':
            ...
            case 'click':
              (!this.multiselect && e) ||
                this.dirListingHandleEvent.call(this.directoryListing, t);
              break;
            case 'dblclick':
              if ('directory' === this.directoryListing.modelForClick(t).type)
                this.dirListingHandleEvent.call(this.directoryListing, t);
              else if (
                (t.preventDefault(),
                t.stopPropagation(),
                this.acceptFileOnDblClick)
              ) {
                const t = document.querySelector(`.${i} .jp-mod-accept`);
                t && t.click();
              }
              break;
            default:
      ...
      const o = async (t, e) => {
        const a = await r.init({
            manager: t,
            filter: e.filter,
            multiselect: e.multiselect,
            includeDir: e.includeDir,
            rootPath: e.rootPath,
          ...
          s = new l.Dialog({
            ...
            buttons: [
              ...
              l.Dialog.okButton({ label: 'Select' })
            ]
          });
        return (
          s.addClass('elyra-browseFileDialog'),
          ...
          s.launch().then(t => {
            if (
              ((document.body.className = document.body.className
                .replace(i, '')
                .trim()),
              e.rootPath && t.button.accept && t.value.length)
            ) {
              const a = e.rootPath.endsWith('/')
                ? e.rootPath
                : e.rootPath + '/';
              t.value.forEach(t => {
      ...
      class g extends d.Component {
        constructor(t) {
          super(t), (this.node = d.createRef());
        }
        handleClick() {
          let t = this.props.onClick();
          'string' != typeof t && (t = this.props.feedback),
            t &&
              (this.node.current.setAttribute('data-feedback', t),
              setTimeout(() => {
                this.node.current.removeAttribute('data-feedback');
              }, 750));
        }
        render() {
          const { children: t, className: e } = this.props,
            a = 'elyra-feedbackButton ' + e;
      ...
      const m = 'elyra-button',
        v = 'elyra-expandableContainer-button';
      class w extends d.Component {
        constructor(t) {
          super(t), (this.state = { expanded: !1 });
        }
        toggleDetailsDisplay() {
          const t = !this.state.expanded;
          this.props.onBeforeExpand && this.props.onBeforeExpand(t),
          ...
          return d.createElement(
            ...
            d.createElement(
              ...
              d.createElement(
                ...
                this.state.expanded
                  ? d.createElement(p.caretDownIcon.react, {
                      tag: 'span',
                      elementPosition: 'center',
                      width: '20px'
                    })
                  : d.createElement(p.caretRightIcon.react, {
                      tag: 'span',
                      elementPosition: 'center',
                      width: '20px'
                    })
                ...
                e.map(e =>
                  d.createElement(
                    g,
                    {
                      ...
                      title: e.title,
                      feedback: e.feedback || '',
                      className: t + ' elyra-expandableContainer-actionButton',
                      onClick: () => {
                        e.onClick();
                      }
                    },
                    d.createElement(e.icon.react, {
                      tag: 'span',
                      elementPosition: 'center',
                      width: '16px'
                    })
      ...
      class u extends d.Component {
        ...
        updateDialogSize(t) {
          ...
          const e = this.dialogNode.clientWidth,
            a = this.dialogNode.clientHeight;
          t && (e < 600 || a < 400)
            ? ((this.collapsedDimensions = [e, a]),
              (this.dialogNode.style.width = Math.max(e, 600) + 'px'),
          ...
          const t = this.props.traceback
            ? d.createElement(
                w,
                {
                  ...
                  onBeforeExpand: t => {
                    this.updateDialogSize(t);
                  }
                },
                d.createElement('pre', null, this.props.traceback)
              )
            : null;
          return d.createElement(
            'div',
            { className: 'elyra-errorDialog-messageDisplay' },
            d.createElement('div', null, this.props.message),
            t,
            d.createElement('div', null, this.props.default_msg)
          );
        }
      }
      const y = async (t, e) => {
          const a = t.body,
            s = new l.Dialog(t);
          if (e) e(s);
          else if (a instanceof n.Widget) {
            const e = a.node.querySelectorAll('[data-form-required]');
            if (e && e.length > 0) {
              const a = new Set(),
                l = s.handleEvent;
              s.handleEvent = t => {
              ...
              const n = t.defaultButton || t.buttons.length - 1,
                i = s.node
                  .querySelector('.jp-Dialog-footer')
                  .getElementsByTagName('button')[n];
              (i.className += ' elyra-DialogDefaultButton'),
                e.forEach(t => {
                  b(t, a);
                  const l = t.tagName.toLowerCase();
                  'select' === l
                    ? t.addEventListener('change', t => {
                        b(t.target, a), C(a, e, i);
                      })
                    : ('input' !== l && 'textarea' !== l) ||
        ...
        b = (t, e) => {
          t.value.trim() ? e.add(t) : e.delete(t);
        },
        C = (t, e, a) => {
          t.size === e.length ? f(a) : x(a);
        },
        M = new p.LabIcon({
          name: 'elyra:import',
          svgstr:
      ...
      class F {
        static encode(t) {
          return 'data:image/svg+xml;utf8,' + encodeURIComponent(t.svgstr);
        }
        static colorize(t, e, a) {
          let l = t.svgstr;
          return (
            e && (l = l.replace(/fill="[^(none)]+?"/gi, `fill="${e}"`)),
            a && (l = l.replace(/stroke="[^(none)]+?"/gi, `stroke="${a}"`)),
            p.LabIcon.resolve({
              icon: {
                name: `${t.name}${e ? ':' + e : ''}${a ? ':' + a : ''}`,
                svgstr: l
      ...
      class S extends d.Component {
        constructor() {
          super(...arguments),
            (this.renderCreateOption = (t, e, a) =>
              d.createElement(j.MenuItem, {
                icon: 'add',
                key: 'createOption',
                text: `Create "${t}"`,
                active: e,
            ...
            (this.filterDropdown = (t, e, a, l) => {
              const s = e.toLowerCase(),
                n = t.toLowerCase();
              return n === s ? s === n : ('' + s).indexOf(n) >= 0;
            });
        }
        itemRenderer(t, e) {
          return d.createElement(p.Button, {
        ...
        render() {
          let t = this.props.description ? this.props.description : '';
          return (
            this.props.intent == j.Intent.DANGER &&
            ...
            d.createElement(
              ...
              d.createElement(
                p.Select,
                {
                  ...
                  onItemSelect: t => {
                    this.props.handleDropdownChange(this.props.schemaField, t);
                  },
                  itemRenderer: this.itemRenderer
                },
                d.createElement(p.Button, {
      ...
      class _ extends h().Component {
        render() {
          return h().createElement(O(), {
            ...
            invertTheme: !1,
            hideRoot: !0,
            getItemString: (t, e, a, l) =>
              Array.isArray(e)
                ? h().createElement('span', null, a, ' ', l)
                : 0 === Object.keys(e).length
                ? h().createElement('span', null, a)
                : null,
            labelRenderer: ([t, e]) =>
              h().createElement('span', { className: 'cm-keyword' }, t + ': '),
            valueRenderer: t => {
              let e = 'cm-string';
              return (
                'number' == typeof t && (e = 'cm-number'),
                ('true' !== t && 'false' !== t) || (e = 'cm-keyword'),
                h().createElement('span', { className: e }, '' + t)
              );
            }
          });
        }
