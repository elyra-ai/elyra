(self.webpackChunk_elyra_metadata_common =
  ...
  [883],
  {
    ...
    3291: (e, t, n) => {
      ...
      n(2379)(a, { hmr: !0, transform: void 0, insertInto: void 0 }),
    ...
    9883: (e, t, n) => {
      ...
      n.r(t),
        n.d(t, {
          DropDown: () => S,
          ExpandableComponent: () => u,
          ExpandableErrorDialog: () => y,
          IconUtil: () => P,
          JSONComponent: () => R,
          clearPipelineIcon: () => A,
          codeSnippetIcon: () => M,
          ...
          dragDropIcon: () => D,
          elyraIcon: () => k,
          enableDialogButton: () => b,
          errorIcon: () => H,
          exportPipelineIcon: () => Z,
          helpIcon: () => N,
          importIcon: () => L,
          pipelineIcon: () => E,
          runtimesIcon: () => V,
          savePipelineIcon: () => I,
          showBrowseFileDialog: () => c,
          showFormDialog: () => w,
          trashIcon: () => B
        });
      var a = n(4268),
      ...
      class o extends l.BreadCrumbs {
        constructor(e) {
          super(e), (this.model = e.model), (this.rootPath = e.rootPath);
        }
        onUpdateRequest(e) {
          super.onUpdateRequest(e);
          const t = this.model.manager.services.contents.localPath(
            this.model.path
          );
          t &&
            this.rootPath &&
            0 === t.indexOf(this.rootPath) &&
            document
              .querySelectorAll(
                '.elyra-browseFileDialog .jp-BreadCrumbs > span[title]'
              )
              .forEach(e => {
                0 === e.title.indexOf(this.rootPath)
                  ? (e.className = e.className
                      .replace('elyra-BreadCrumbs-disabled', '')
                      .trim())
                  : -1 === e.className.indexOf('elyra-BreadCrumbs-disabled') &&
                    (e.className += ' elyra-BreadCrumbs-disabled');
              });
        }
      }
      class r extends s.Widget {
        constructor(e) {
          super(e),
            (this.model = new l.FilterFileBrowserModel({
              manager: e.manager,
              filter: e.filter
            }));
          const t = (this.layout = new s.PanelLayout());
          (this.directoryListing = new l.DirListing({ model: this.model })),
            (this.acceptFileOnDblClick = e.acceptFileOnDblClick),
            (this.multiselect = e.multiselect),
            (this.includeDir = e.includeDir),
            (this.dirListingHandleEvent = this.directoryListing.handleEvent),
            (this.directoryListing.handleEvent = e => {
              this.handleEvent(e);
            }),
            (this.breadCrumbs = new o({
              model: this.model,
              rootPath: e.rootPath
            })),
            t.addWidget(this.breadCrumbs),
            t.addWidget(this.directoryListing);
        }
        static async init(e) {
          const t = new r(e);
          return (
            e.startPath
              ? (e.rootPath && 0 !== e.startPath.indexOf(e.rootPath)) ||
                (await t.model.cd(e.startPath))
              : e.rootPath && (await t.model.cd(e.rootPath)),
            t
          );
        }
        getValue() {
          const e = this.directoryListing.selectedItems(),
            t = [];
          let n = null;
          for (; void 0 !== (n = e.next()); )
            (this.includeDir || 'directory' !== n.type) && t.push(n);
          return t;
        }
        handleEvent(e) {
          let t = !1;
          switch (
            ...
            case 'click':
              (!this.multiselect && t) ||
                this.dirListingHandleEvent.call(this.directoryListing, e);
              break;
            case 'dblclick':
              if ('directory' === this.directoryListing.modelForClick(e).type)
                this.dirListingHandleEvent.call(this.directoryListing, e);
              else if (
                (e.preventDefault(),
                e.stopPropagation(),
                ...
                const e = document.querySelector(`.${i} .jp-mod-accept`);
                e && e.click();
              }
              break;
            default:
      ...
      const c = async (e, t) => {
        const n = await r.init({
            manager: e,
            filter: t.filter,
            multiselect: t.multiselect,
            includeDir: t.includeDir,
            rootPath: t.rootPath,
          ...
          l = new a.Dialog({
            ...
            buttons: [
              ...
              a.Dialog.okButton({ label: 'Select' })
            ]
          });
        return (
          l.addClass('elyra-browseFileDialog'),
          ...
          l.launch().then(e => {
            if (
              ((document.body.className = document.body.className
                .replace(i, '')
                .trim()),
              t.rootPath && e.button.accept && e.value.length)
            ) {
              const n = t.rootPath.endsWith('/')
                ? t.rootPath
                : t.rootPath + '/';
              e.value.forEach(e => {
                e.path = e.path.replace(n, '');
              });
            }
            return e;
          })
          ...
          return d.createElement(
            ...
            d.createElement(
              ...
              d.createElement(
                ...
                this.state.expanded
                  ? d.createElement(h.caretDownIcon.react, {
                      tag: 'span',
                      elementPosition: 'center',
                      width: '20px'
                    })
                  : d.createElement(h.caretRightIcon.react, {
                      tag: 'span',
                      elementPosition: 'center',
                      width: '20px'
                    })
      ...
      class y extends d.Component {
        ...
        updateDialogSize(e) {
          ...
          const t = this.dialogNode.clientWidth,
            n = this.dialogNode.clientHeight;
          e && (t < 600 || n < 400)
            ? ((this.collapsedDimensions = [t, n]),
              (this.dialogNode.style.width = Math.max(t, 600) + 'px'),
              (this.dialogNode.style.height = Math.max(n, 400) + 'px'))
            : !e &&
      ...
      const w = async (e, t) => {
          const n = e.body,
            l = new a.Dialog(e);
          if (t) t(l);
          else if (n instanceof s.Widget) {
            const t = n.node.querySelectorAll('[data-form-required]');
            if (t && t.length > 0) {
              const n = new Set(),
                a = l.handleEvent;
              l.handleEvent = e => {
              ...
              const s = e.defaultButton || e.buttons.length - 1,
                i = l.node
                  .querySelector('.jp-Dialog-footer')
                  .getElementsByTagName('button')[s];
        ...
        f = (e, t) => {
          e.value.trim() ? t.add(e) : t.delete(e);
        },
        C = (e, t, n) => {
          e.size === t.length ? b(n) : x(n);
        },
        L = new h.LabIcon({
          name: 'elyra:import',
          svgstr:
      ...
      class P {
        static encode(e) {
          return 'data:image/svg+xml;utf8,' + encodeURIComponent(e.svgstr);
        }
        static colorize(e, t, n) {
          let a = e.svgstr;
          return (
            t && (a = a.replace(/fill="[^(none)]+?"/gi, `fill="${t}"`)),
            n && (a = a.replace(/stroke="[^(none)]+?"/gi, `stroke="${n}"`)),
            h.LabIcon.resolve({
              icon: {
                name: `${e.name}${t ? ':' + t : ''}${n ? ':' + n : ''}`,
                svgstr: a
      ...
      class S extends d.Component {
        constructor() {
          super(...arguments),
            (this.renderCreateOption = (e, t, n) =>
              d.createElement(F.MenuItem, {
                icon: 'add',
                key: 'createOption',
                text: `Create "${e}"`,
                active: t,
            ...
            (this.filterDropdown = (e, t, n, a) => {
              const l = t.toLowerCase(),
                s = e.toLowerCase();
              return s === l ? l === s : ('' + l).indexOf(s) >= 0;
            });
        }
        itemRenderer(e, t) {
        ...
        render() {
          ...
          return (
            this.props.intent == F.Intent.DANGER &&
      ...
      class R extends p().Component {
        render() {
          return p().createElement(z.Z, {
            ...
            invertTheme: !1,
            hideRoot: !0,
            getItemString: (e, t, n, a) =>
              Array.isArray(t)
                ? p().createElement('span', null, n, ' ', a)
                : 0 === Object.keys(t).length
                ? p().createElement('span', null, n)
                : null,
            labelRenderer: ([e, t]) =>
              p().createElement('span', { className: 'cm-keyword' }, e + ': '),
            valueRenderer: e => {
              let t = 'cm-string';
              return (
                'number' == typeof e && (t = 'cm-number'),
                ('true' !== e && 'false' !== e) || (t = 'cm-keyword'),
                p().createElement('span', { className: t }, '' + e)
              );
            }
          });
        }
