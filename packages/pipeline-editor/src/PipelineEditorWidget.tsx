                ...
                showDialog({
                  ...
                  body: (
                    <p>
                      ...
                      instructions in{' '}
                      <a
                        href="https://elyra.readthedocs.io/en/v3.14.2rc1/user_guide/pipeline-components.html#example-custom-components"
                        target="_blank"
                        rel="noreferrer"
                      >
        ...
        return showDialog({
          ...
          body: (
            <p>
              ...
              <br />
              <a
                href="https://elyra.readthedocs.io/en/v3.14.2rc1/user_guide/best-practices-custom-pipeline-components.html#troubleshooting-missing-pipeline-components"
                target="_blank"
                rel="noreferrer"
              >
                Learn more...
