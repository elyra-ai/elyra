(self.webpackChunk_elyra_code_snippet_extension =
  ...
  [650],
  {
    ...
    9365: (e, t, a) => {
      a(4371), a(8158), a(8237), a(9077), (e.exports = a(788).Symbol);
    },
    6408: (e, t, a) => {
      a(506), a(3063), (e.exports = a(6426).f('iterator'));
    },
    160: e => {
      e.exports = function(e) {
    ...
    3924: (e, t, a) => {
      ...
      e.exports = function(e, t, a, v, y, m, g) {
        ...
        var _,
          ...
          M = !1,
          k = e.prototype,
          A = k[c] || k['@@iterator'] || (y && k[y]),
          j = A || E(y),
          w = y ? (S ? E('entries') : j) : void 0,
          R = ('Array' == t && k.entries) || A;
        if (
          (R &&
            (x = l(R.call(new e()))) !== Object.prototype &&
            x.next &&
          ...
          if (
            ((_ = { values: S ? j : E(p), keys: m ? j : E(d), entries: w }), g)
          )
      ...
      var r = a(9444),
        ...
        $ =
          ...
          f(function() {
            ...
            ? function(e, t, a) {
                var r = w(z, t);
                r && delete z[t], R(e, t, a), r && e !== z && R(z, t, r);
              }
            : R,
        K = function(e) {
        ...
        X = function(e, t) {
          if (((e = O(e)), (t = x(t, !0)), e !== z || !n(q, t) || n(G, t))) {
            var a = w(e, t);
            return (
        ...
        Q = function(e) {
          for (var t, a = T(O(e)), r = [], s = 0; a.length > s; )
            n(q, (t = a[s++])) || t == D || t == i || r.push(t);
          return r;
        },
        ee = function(e) {
          for (
            var t, a = e === z, r = T(a ? G : O(e)), s = [], o = 0;
            r.length > o;

          )
            !n(q, (t = r[o++])) || (a && !n(z, t)) || s.push(q[t]);
          return s;
        };
      U ||
        (u(
          (F = function() {
            ...
            return s && V && $(z, e, { configurable: !0, set: t }), K(e);
          }).prototype,
          'toString',
          function() {
            return this._k;
        ...
        (a(8366).f = Y),
        (k.f = ee),
        s && !a(2245) && u(z, 'propertyIsEnumerable', Y, !0),
        (p.f = function(e) {
          return K(d(e));
        })),
        o(o.G + o.W + o.F * !U, { Symbol: F });
      for (
        ...
        d(te[ae++]);
      for (var re = j(d.store), ne = 0; re.length > ne; ) h(re[ne++]);
      o(o.S + o.F * !U, 'Symbol', {
        for: function(e) {
    ...
    3274: (e, t, a) => {
      ...
      var x,
        ...
        A = (x = /[^.]+$/.exec((k && k.keys && k.keys.IE_PROTO) || ''))
          ? 'Symbol(src)_1.' + x
          : '',
        j = S.toString,
        w = M.hasOwnProperty,
      ...
      function G(e, t, a, r, n, s, o, u, i, f) {
        ...
        return function v() {
          ...
          if (
            ...
            var S = O(g, E);
            return z(e, t, G, v.placeholder, a, g, S, u, i, f - m);
          }
          var M = c ? a : this,
            k = b ? M[e] : e;
          return (
            (m = g.length),
            u ? (g = Z(g, u)) : p && m > 1 && g.reverse(),
            l && i < m && (g.length = i),
      ...
      function z(e, t, a, r, n, s, o, u, i, f) {
        var l = 8 & t;
        ...
        return (c.placeholder = r), H(c, e, t);
      }
      function U(e) {
      ...
      function Y(e, t, a) {
            ...
            d =
              8 == t || 16 == t
                ? (function(e, t, a) {
                    ...
                    return function n() {
                      for (
                        var s = arguments.length, o = Array(s), u = s, i = U(n);
                        u--;
        ...
        return (r.placeholder = Y.placeholder), r;
      }
      function X(e) {
        var t = typeof e;
