...
class SchedulerHandler(IPythonHandler):
    ...
    def post(self, *args, **kwargs):
        ...
        for component in options['nodes']:
            ...
            labels[component['id']] = component['app_data']['artifact']
            docker_images[component['id']] = component['app_data']['image']
        ...
        def cc_pipeline():
            ...
            for componentId, inputs in links.items():
                ...
                output_filename = options['app_data']['ui_data']['title'] + '-' + datetime.now().strftime("%m%d%H%M%S") + ".tar.gz"
        ...
        pipeline_name = options['app_data']['ui_data']['title']+'-'+datetime.now().strftime("%m%d%H%M%S")
