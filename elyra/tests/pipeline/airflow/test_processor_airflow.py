...
def test_initialize_airflow_with_airflow_available(monkeypatch, processor):
    """Test _initialize_airflow when Airflow is available."""
...
def test_initialize_airflow_with_airflow_3_available(monkeypatch, processor):
    """Test _initialize_airflow when Airflow 3.x is available."""
...
def test_initialize_airflow_already_initialized(processor):
    """Test _initialize_airflow when already initialized (should be no-op)."""
