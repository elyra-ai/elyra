...
def test_parse_kfp_component_file_no_inputs():
    ...
    # 'kubernetes_tolerations', and 'elyra_disallow_cached_output'), the component description if
    # it exists (which it does for this component), and the output parameter for this component
    num_common_params = 8
