...
class GitLabClient(LoggingConfigurable):
    ...
    def __init__(self,
        ...
        try:
            self.client = Gitlab(self.server_url,
                                 private_token=token)
            ...
            raise RuntimeError(f'Error accessing repository {self.project_name}: {gle}. ' +
                               'Please validate your runtime configuration details and retry.') from gle
    ...
    def upload_dag(self,
        ...
        try:
            ...
            raise RuntimeError(f'Error uploading DAG to branch {self.branch}: {gle} ' +
                               'Please validate your runtime configuration details and try again.') from gle
