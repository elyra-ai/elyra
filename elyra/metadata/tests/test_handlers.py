...
from .conftest import bogus_location, namespace_location


os.environ["METADATA_TESTING"] = "1"  # Enable metadata-tests namespace


# class MetadataTestBase(ServerApp):
...
def test_get_instances(fetch):
    # Ensure all valid metadata can be found
    r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE)
    assert r.code == 200
    metadata = r.json()
...
def test_get_empty_namespace_instances(fetch):
...
#
#     def test_get_hierarchy_instances(fetch):
#         # Ensure all valid metadata can be found
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE,
...
#
#     def test_create_instance(fetch):
...
#
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE, body=body,
...
#
#     def test_create_hierarchy_instance(fetch):
...
#
#     def test_create_invalid_instance(fetch):
#         """Create a simple instance - not conflicting with factory instances. """
#
...
#         assert "Validation failed for instance 'invalid'" in r.text
#
#     def test_create_instance_missing_schema(fetch):
...
#
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE, 'missing_schema',
#                   base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 404
#
#     def test_update_non_existent(fetch):
...
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE, 'valid', body=body,
#                   method='PUT', base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 404
#
#     def test_update_instance(fetch):
...
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE, 'update_bad_md',
#                   base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 200
#         instance = r.json()
#
...
#
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE, 'update_bad_md', body=body2,
#                   method='PUT', base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 400
#
...
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE, 'update_fields', body=body,
#                   method='PUT', base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 200
#         instance = r.json()
#         assert instance['metadata']['number_range_test'] == 7
...
#
#     def test_update_hierarchy_instance(fetch):
...
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE, 'byo_2', body=body,
#                   method='PUT', base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 200
#
...
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE, 'byo_2',
#                   base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 200
#         instance = r.json()
...
#         r = fetch('elyra', 'metadata', METADATA_TEST_NAMESPACE, 'missing',
...
#         # Validate missing is not found
#         r = fetch('elyra', 'schema', 'runtimes', 'missing',
#                   base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 404
...
#         r = fetch('elyra', 'schema', namespace,
#                   base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 200
...
#         r = fetch('elyra', 'schema', namespace, expected,
#                   base_url=self.base_url(), headers=self.auth_headers())
#         assert r.code == 200
