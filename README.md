...
```
docker run -it -p 8888:8888 elyra/elyra:1.3.3 jupyter lab --debug
```
...
```
docker run -it -p 8888:8888 -v ${HOME}/opensource/jupyter-notebooks/:/home/jovyan/work -w /home/jovyan/work elyra/elyra:1.3.3 jupyter lab --debug
```
...
Known labextensions:
   app dir: /.../share/jupyter/lab
        @elyra/code-snippet-extension v1.3.3  enabled  OK*
        @elyra/metadata-extension v1.3.3  enabled  OK*
        @elyra/pipeline-editor-extension v1.3.3  enabled  OK*
        @elyra/python-editor-extension v1.3.3  enabled  OK*
        @elyra/theme-extension v1.3.3  enabled  OK*
