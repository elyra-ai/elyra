...
- [![Launch latest stable version](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/elyra-ai/elyra/v1.5.2?urlpath=lab/tree/binder-demo) (Latest stable version - see [changelog](/docs/source/getting_started/changelog.md) for recent updates)
...
Known labextensions:
   app dir: /.../share/jupyter/lab
        @elyra/code-snippet-extension v1.6.0-dev  enabled  OK*
        @elyra/metadata-extension v1.6.0-dev  enabled  OK*
        @elyra/pipeline-editor-extension v1.6.0-dev  enabled  OK*
        @elyra/python-editor-extension v1.6.0-dev  enabled  OK*
        @elyra/theme-extension v1.6.0-dev  enabled  OK*
