...
```
docker run -it -p 8888:8888 elyra/elyra:4.1.1 jupyter lab --debug
```
...
```
docker run -it -p 8888:8888 -v ${HOME}/opensource/jupyter-notebooks/:/home/jovyan/work -w /home/jovyan/work elyra/elyra:4.1.1 jupyter lab --debug
```
