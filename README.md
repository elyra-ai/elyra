...
```
docker run -it -p 8888:8888 elyra/elyra:3.3.0rc1 jupyter lab --debug
```
...
```
docker run -it -p 8888:8888 -v ${HOME}/opensource/jupyter-notebooks/:/home/jovyan/work -w /home/jovyan/work elyra/elyra:3.3.0rc1 jupyter lab --debug
```
