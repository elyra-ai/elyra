...
Custom components can be added, modified, cloned, and removed in the _Pipeline Components_ panel.
...
#### Cloning a component catalog entry

To clone a component catalog entry:
1. Open the `Pipeline Components` panel.
1. Click the clone icon next to the entry name.
1. Follow the steps in '[_Modifying a component catalog entry_](#modifying-a-component-catalog-entry)' to customize the cloned entry.
