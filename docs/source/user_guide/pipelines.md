...
##### Resources: CPU, RAM, and GPU
   ...
   - You can optionally provide "GPU Vendor" to specify a custom Kubernetes GPU resource type other than `nvidia.com/gpu`, for more information, please check out [here](https://kubernetes.io/docs/tasks/manage-gpus/scheduling-gpus/).
