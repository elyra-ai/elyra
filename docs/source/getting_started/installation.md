...
Known labextensions:
   app dir: /.../share/jupyter/lab
        @elyra/code-snippet-extension v2.0.0  enabled  OK*
        @elyra/metadata-extension v2.0.0  enabled  OK*
        @elyra/pipeline-editor-extension v2.0.0  enabled  OK*
        @elyra/python-editor-extension v2.0.0  enabled  OK*
        @elyra/theme-extension v2.0.0  enabled  OK*
...
docker run -it -p 8888:8888\
 ...
 -w /home/jovyan/work\
 elyra/elyra:2.0.0 jupyter lab --debug
```
