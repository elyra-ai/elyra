...
- `elyra[airflow-gitea]` - install the Elyra core features and Gitea support for [Apache Airflow pipelines](https://github.com/apache/airflow) (supports Airflow 2.x and 3.x)
