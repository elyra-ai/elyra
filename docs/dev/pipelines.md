...
The pipeline is then submitted to the **Elyra Scheduler** which parses, properly package and then
submit to the chosen target runtime (e.g. Kubeflow Pipelines).
