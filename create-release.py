...
def publish_release(working_dir) -> None:
    ...
    files_to_publish = [
        ...
        f'{config.work_dir}/airflow-notebook/airflow-notebook--{config.new_version}-py3-none-any.whl',
        f'{config.work_dir}/airflow-notebook/airflow-notebook--{config.new_version}.tar.gz',
        f'{config.work_dir}/kfp-notebook/kfp-notebook--{config.new_version}-py3-none-any.whl',
        f'{config.work_dir}/kfp-notebook/kfp-notebook--{config.new_version}.tar.gz',
