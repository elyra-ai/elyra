"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[1268],{
...
/* harmony import */ var _lezer_lr__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(27421);
...
class LocalTokenSet extends TokenSet {
    ...
    buildLocalGroup(states, skipInfo, id) {
        ...
        return {
            groupID: id,
            create: () => new _lezer_lr__WEBPACK_IMPORTED_MODULE_1__/* .LocalTokenGroup */ .uC(fullData, precOffset, this.fallback ? this.fallback.id : undefined),
